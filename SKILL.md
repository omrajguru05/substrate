...
5. **Apple HIG & Universal Accessibility Compliance:** Every interface must be auditable via `omrajguru/hig-compliance-auditor`. Uphold the 8 Apple HIG Design Principles (Purpose, Agency, Responsibility, Familiarity, Flexibility, Simplicity, Craft, Delight) and satisfy all 6 Disability Categories (Vision, Hearing, Mobility, Speech, Cognitive, Motion).
